...
class ClientWindow:
    ...
    def create_widgets(self):
        ...
        # Status
        self.status_label = ttk.Label(input_frame, text="Connecting to host...", style="Status.TLabel", wraplength=350)
        ...
        reconnect_btn = tk.Button(
            main_frame, text="🔄 Reconnect", font=("Segoe UI", 9),
            bg="#6366f1", fg="white", command=self.reconnect, width=10
        )
        reconnect_btn.pack(pady=3)
